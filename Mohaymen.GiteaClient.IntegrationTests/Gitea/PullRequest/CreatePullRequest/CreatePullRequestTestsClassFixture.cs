...
public class CreatePullRequestTestsClassFixture : IAsyncLifetime
{
    ...
    public CreatePullRequestTestsClassFixture(GiteaCollectionFixture giteaCollectionFixture)
    {
    ...
    public async Task InitializeAsync()
    {
        ...
        await _testBranchCreator.CreateBranch(repo, BranchName);
    }
